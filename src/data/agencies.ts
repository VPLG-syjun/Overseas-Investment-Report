...
export const forms: Record<string, ReportForm> = {
  ...
  'form-offshore-investment': {
    id: 'form-offshore-investment',
    name: '역외금융회사 투자신고서',
    formNumber: '별지 제9-2호',
    downloadUrl: '/forms/form-offshore-investment.pdf',
    description: '역외금융회사 투자 시 한국은행에 제출하는 신고서',
  },
  'form-branch': {
    id: 'form-branch',
    name: '해외지사 설치 신고서',
  ...
  // 루트 B 서식 (금융회사) - 금융회사 해외진출 규정 시행세칙
  'form-b-financial': {
    id: 'form-b-financial',
    name: '해외직접투자 신고수리 신청서 (금융업)',
    formNumber: '시행세칙 별지 제2호',
    downloadUrl: '/forms/form-b-financial.pdf',
    description: '금융회사의 금융업 해외직접투자 신고수리 신청서',
  },
  'form-b-non-financial': {
    id: 'form-b-non-financial',
    name: '해외직접투자 신고서 (비금융업)',
    formNumber: '시행세칙 별지 제1호',
